...
let slider_about = new Swiper('.slider__body', {
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.controls-slider__arrow_next',
		prevEl: '.controls-slider__arrow_prev',
	},
	/*
	breakpoints: {
		320: {
...
$(document).ready(function(){
    ...
    function toggleSlide(item) {
        $(item).each(function(i) {
            $(this).on('click', function(e) {
                e.preventDefault();
                $('.item-catalog__info').eq(i).toggleClass('item-catalog__info_active');
    ...
    $('.item-catalog__btn').each(function(i) {
        $(this).on('click', function() {
            $('#buy .popup__name').text($('.item-catalog__title').eq(i).text());
